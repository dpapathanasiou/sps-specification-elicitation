...
4. If you have a model with no evaluation errors, take the "stdout" portion of the evaluation response, and use the <visualization> tool to generate an html page to show the user, and then ask the user to confirm whether or not it is correct
